# Intelli-Credit-Aveva Backend Architecture
...
pip install langgraph qdrant-client langchain-mcp-adapters openlayer fastapi uvicorn
...
| Constraint Enforcement | Deterministic Repair Layer |
| Orchestration | LangGraph (Pydantic state machine) |
| Vector Memory | Qdrant (in-memory, L2-normalized) |
| Secure Execution | Model Context Protocol |
| Observability | LangSmith + Openlayer |
